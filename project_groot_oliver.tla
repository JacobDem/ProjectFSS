           ...
           /\ IF sporen[6] # -1
              THEN CASE sporen[6] = 1 -> CASE /\ (\/ sporen[9] = -1 \/ sporen[9] = 1) /\ COBottomBezet = FALSE -> /\ bestemmingen' = [bestemmingen EXCEPT ![6] = 9] /\ COBottomBezet' = TRUE /\ UNCHANGED COTopBezet /\ UNCHANGED CWTopBezet /\ UNCHANGED CWBottomBezet /\ UNCHANGED C2Bezet
                     ...
                     [] sporen[6] = 0 -> CASE /\ (\/ sporen[3] = -1 \/ sporen[3] = 0) /\ CWBottomBezet = FALSE -> /\ bestemmingen' = [bestemmingen EXCEPT ![6] = 3] /\ CWBottomBezet' = TRUE /\ UNCHANGED COBottomBezet /\ UNCHANGED COTopBezet /\ UNCHANGED CWTopBezet /\ UNCHANGED C2Bezet
                                              [] /\ (\/ sporen[4] = -1 \/ sporen[4] = 0) /\ CWBottomBezet = FALSE -> /\ bestemmingen' = [bestemmingen EXCEPT ![5] = 2] /\ CWBottomBezet' = TRUE /\ UNCHANGED COBottomBezet /\ UNCHANGED COTopBezet /\ UNCHANGED CWTopBezet /\ UNCHANGED C2Bezet
                                              [] /\ (\/ sporen[1] = -1 \/ sporen[1] = 0) /\ CWTopBezet = FALSE /\ CWBottomBezet = FALSE -> /\ bestemmingen' = [bestemmingen EXCEPT ![6] = 3] /\ CWTopBezet' = TRUE /\ CWBottomBezet' = TRUE /\ UNCHANGED COTopBezet /\ UNCHANGED COBottomBezet /\ UNCHANGED C2Bezet
                                              [] /\ (\/ sporen[2] = -1 \/ sporen[2] = 0) /\ CWTopBezet = FALSE /\ CWBottomBezet = FALSE -> /\ bestemmingen' = [bestemmingen EXCEPT ![6] = 4] /\ CWTopBezet' = TRUE /\ CWBottomBezet' = TRUE /\ UNCHANGED COTopBezet /\ UNCHANGED COBottomBezet /\ UNCHANGED C2Bezet
                                              [] OTHER -> /\ bestemmingen' = [bestemmingen EXCEPT ![6] = 6] /\ C2Bezet' = TRUE /\ UNCHANGED COTopBezet /\ UNCHANGED COBottomBezet /\ UNCHANGED CWTopBezet /\ UNCHANGED CWBottomBezet
...
Verplaatsing == /\ (\E n \in 1..10 : bestemmingen[n] # n) 
                /\ IF \E n \in 1..10 : bestemmingen[n] = 1 THEN \E n \in 1..10 : /\ bestemmingen[n] = 1 /\ newW1' = sporen[n] ELSE newW1' = -1
...
\* Last modified Wed Apr 28 15:37:14 CEST 2021 by Oliver De Vijt
